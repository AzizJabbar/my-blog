    ...
    <>
      ...
      <div className="mx-auto p-8">
        ...
        <div className="flex justify-center ">
          <div className="xl:w-96 bg-white rounded-full shadow-md p-2">
            <div className="relative flex w-full flex-wrap items-stretch ">
              <input
                type="search"
                className="relative m-0 block w-[1%] min-w-0 flex-auto rounded-full bg-transparent bg-clip-padding px-3 py-1.5 text-base font-normal text-neutral-700 outline-none transition duration-300 ease-in-out focus:border-primary-600 focus:text-neutral-700 focus:shadow-te-primary focus:outline-none"
              ...
              {data.map((user) => (
                <tr key={user.id} className="border-b border-slate-100">
                  ...
                  <td className="flex space-x-3 justify-center">
                    ...
                    <UpdateUserModal key={user.id} data={user} />
